...
import { decryptAuctionKey,revealBid } from './utility';
...
class MyBids extends Component {
  ...
  verify = (auction_id, type) => async (e) => {
    e.preventDefault();
    const { SubmissionData, currentAccount, market, blind_contract, vickrey_contract, average_contract } = this.state;
    const contracts = { market, blind_contract, vickrey_contract, average_contract };
